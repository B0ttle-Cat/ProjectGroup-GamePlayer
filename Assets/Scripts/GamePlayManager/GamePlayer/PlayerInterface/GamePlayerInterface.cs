...
namespace BC.GamePlayManager
{
	...
	public abstract class GamePlayerInterface : ComponentBehaviour, ILowLevelPlayerInterface
	{
		...
		protected IGamePlayManager playManager;
		ILowLevelAIManager LowLevelAI => playManager.LowLevelAI;
		IHighLevelAIManager HighLevelAI => playManager.HighLevelAI;
		public override void BaseValidate()
		{
			...
			ThisContainer.TryGetParentObject<IGamePlayManager>(out playManager);
		}
		...
		{
			computer = null;
			if(!playManager.ThisContainer.TryGetChildObject<MapStage>(out var mapStage)) return false;
